...
public class YApiSaveParam implements Serializable {
     ...
     * 请求参数
     */
    private List<Object> req_query;
    /**
     * header
     */
    private List<Object> req_headers;
    /**
     * 请求参数 form 类型
     */
     ...
     * 请求参数
     */
    private List<Object> req_params;
     ...
     */
    public List<Object> getReq_query() {
        return req_query;
    }
     ...
     */
    public void setReq_query(List<Object> req_query) {
     ...
     * @param desc the desc
     */
    public YApiSaveParam(String token, String title, String path, String req_body_other, String res_body,
     ...
     */
    public YApiSaveParam(String token, String title, String path, List req_query, String req_body_other,
            String res_body, Integer projectId, String yapiUrl, boolean req_body_is_json_schema, String method,
            String desc, List header) {
        this.token = token;
        this.title = title;
        this.path = path;
        this.req_query = req_query;
