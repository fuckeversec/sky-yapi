...
import com.sky.AbstractLombokLightCodeInsightTestCase;
import com.sky.util.PsiElementUtil;
  ...
  private void compareConstructors(PsiClass beforeClass, PsiClass afterClass) {
    ...
    for (PsiMethod afterConstructor : afterConstructors) {
      ...
      for (PsiMethod beforeConstructor : beforeConstructors) {
        if (PsiElementUtil
                .methodMatches(beforeConstructor, null, null, afterConstructor.getName(), afterConstructorParameterTypes)) {
